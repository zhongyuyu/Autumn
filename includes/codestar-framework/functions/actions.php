...
if ( ! function_exists( 'csf_export' ) ) {
  function csf_export() {
    ...
    $nonce  = ( ! empty( $_GET['nonce'] ) ) ? sanitize_text_field( $_GET['nonce'] ) : '';
    $unique = ( ! empty( $_GET['unique'] ) ) ? sanitize_text_field( $_GET['unique'] ) : '';
...
if ( ! function_exists( 'csf_import_ajax' ) ) {
  function csf_import_ajax() {
    ...
    $nonce  = ( ! empty( $_POST['nonce'] ) ) ? sanitize_text_field( $_POST['nonce'] ) : '';
    $unique = ( ! empty( $_POST['unique'] ) ) ? sanitize_text_field( $_POST['unique'] ) : '';
