    ...
    public static function field( $field = array(), $value = '', $unique = '', $where = '', $parent = '' ) {
      ...
      if ( ! empty( $field_type ) ) {
        ...
        if ( ! empty( $field['title'] ) ) {
          $subtitle = ( ! empty( $field['subtitle'] ) ) ? '<p class="csf-text-subtitle">'. wp_kses_post( $field['subtitle'] ) .'</p>' : '';
          echo '<div class="csf-title"><h4>'. wp_kses_post( $field['title'] ) .'</h4>'. wp_kses_post( $subtitle ) .'</div>';
        }
