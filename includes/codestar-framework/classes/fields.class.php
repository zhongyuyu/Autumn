...
if ( ! class_exists( 'CSF_Fields' ) ) {
  abstract class CSF_Fields extends CSF_Abstract {
    ...
    public function field_after() {
      ...
      $output .= ( ! empty( $this->field['desc'] ) ) ? '<p class="csf-text-desc">'. wp_kses_post( $this->field['desc'] ) .'</p>' : '';
      $output .= ( ! empty( $this->field['help'] ) ) ? '<span class="csf-help"><span class="csf-help-text">'. wp_kses_post( $this->field['help'] ) .'</span><span class="fas fa-question-circle"></span></span>' : '';
      $output .= ( ! empty( $this->field['_error'] ) ) ? '<p class="csf-text-error">'. wp_kses_post( $this->field['_error'] ) .'</p>' : '';
